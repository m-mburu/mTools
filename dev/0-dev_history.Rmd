...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Functions I normally use for my work and hobies",
    Description = "A package with a collection of useful functions I normally use",
    `Authors@R` = c(
      person("Moses", "Mburu", email = "mmburu20@gmail.com", role = c("aut", "cre"), comment = c(ORCID = "0000-0001-7281-583X"))
    )
  )
)
